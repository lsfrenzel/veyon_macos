/*
 * MacOSServiceFunctions.h - declaration of MacOSServiceFunctions class
 *
...
private:
	static QString launchdPlistPath(const QString& name);
	static QString launchdLabel(const QString& name);
};
